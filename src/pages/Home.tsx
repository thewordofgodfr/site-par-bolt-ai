      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className={`text-4xl md:text-6xl font-bold mb-4 ${isDark ? 'text-white' : 'text-gray-800'}`}>
              Random Bible
            </h1>
            <p className={`text-xl md:text-2xl ${isDark ? 'text-blue-400' : 'text-blue-600'} font-medium`}>
              {t('godSpeaks')}
            </p>
          </div>

          {/* Verse Card */}
          <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-2xl shadow-2xl border p-8 md:p-12 transition-all duration-300 hover:shadow-3xl`}>
            <h2 className={`text-2xl font-semibold text-center mb-8 ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
              {t('randomVerse')}
            </h2>
